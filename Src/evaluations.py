...
def generate_ai_response(prompt_template: str, prompt_params: dict, llm_model: str = "gpt-4") -> str:
...
def get_summary_consistency_reasoning(summary: str, original_text: str, metric_value: int) -> str:
    configs = read_yaml("../prompts_configs.yaml")
...
def get_summaries_match_reasoning(llm_summary: str, expected_summary: str, evaluation_value: str) -> str:
    configs = read_yaml("../prompts_configs.yaml")
    matching_parms = configs["SUMMARY"]["MATCHING_EVALUATION"]
...
def get_aspects_accuracy(llm_keywords: List[str], expected_aspects:str, source_text: str) -> str:
    configs = read_yaml("../prompts_configs.yaml")
...
def get_aspects_consistency_reasoning(llm_keywords: str, expected_aspects: str, metric_value: int) -> str:
    configs = read_yaml("../prompts_configs.yaml")
...
def get_aspect_matching_reasoning(aspects_generated: List[str], expected_aspects: List[str]):
    configs = read_yaml("../prompts_configs.yaml")
